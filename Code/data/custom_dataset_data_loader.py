...
def CreateDataset(opt):
    ...
    assert opt.datatype=="Discriminator" or opt.datatype=="Generator","config.datatype cannot be recognized"
    if opt.datatype=="Discriminator":
      dataset = DiscriminatorDataset()
    elif opt.datatype=="Generator":
