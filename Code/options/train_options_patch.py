...
def get_config(type='train'):
    ...
    config.depths = [2,2]
    config.depths_decoder = [2,2]
    config.num_heads=[12,24]
    config.mlp_ratio = 4.
    ...
    # config.validation_pre_folder = "/content/drive/MyDrive/SwinGan/Dataset/pre_validation/debug/"
    # config.validation_post_folder = "/content/drive/MyDrive/SwinGan/Dataset/post_validation/debug/"
    # config.validation_brain_mask_folder = "/content/drive/MyDrive/SwinGan/Dataset/brain_mask_validation/debug/"

    config.img_size = (96, 96, 96)
    config.window_size = (12, 12, 12)
    config.embed_dim = 48
    ...
    config.gpu_ids = 0
    config.TABS_lr = 1e-3
    config.TABS_momentum=float(0.9)
    config.Discriminator_lr = 1e-4
    config.Discriminator_momentu=float(0.9)
    config.Trans_lr=1e-4
    config.Trans_momentum=float(0.9)
